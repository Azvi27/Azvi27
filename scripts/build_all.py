...
def generate_build_card():
    ...
    # Kartu Build dengan Sprite & Quotes diposisikan lebih ke tengah secara simetris
  ...
  <!-- Bagian Atas: Sprite & Quotes Digeser ke Tengah -->
  ...
  <!-- Bagian Bawah: DX Driver Simulator (12s Loop) -->
  <g transform="translate(18, 146)">
    ...
    <g>
      ...
      <circle cx="4.5" cy="66" r="1.5" fill="#854d0e"/><circle cx="4.5" cy="85" r="1.5" fill="#854d0e"/><circle cx="4.5" cy="104" r="1.5" fill="#854d0e"/>
      <rect x="365" y="52" width="9" height="66" rx="2" fill="#facc15" stroke="#ca8a04" stroke-width="1"/>
      <circle cx="369.5" cy="66" r="1.5" fill="#854d0e"/><circle cx="369.5" cy="85" r="1.5" fill="#854d0e"/><circle cx="369.5" cy="104" r="1.5" fill="#854d0e"/>
    </g>
    ...
    <g clip-path="url(#dynamoClip)">
      <rect x="50" y="66" width="28" height="48" fill="#dc2626"><animate attributeName="opacity" values="0.15; 0.15; 0.15; 0.85; 0.85" keyTimes="0; 0.16; 0.33; 0.50; 1" dur="12s" repeatCount="indefinite"/></rect>
      <rect x="78" y="66" width="28" height="48" fill="#2563eb"><animate attributeName="opacity" values="0.15; 0.15; 0.15; 0.85; 0.85" keyTimes="0; 0.16; 0.33; 0.50; 1" dur="12s" repeatCount="indefinite"/></rect>
      <circle cx="78" cy="84" r="16" fill="#facc15" opacity="0.4"><animate attributeName="r" values="8; 8; 18; 24; 16" keyTimes="0; 0.50; 0.65; 0.78; 1" dur="12s" repeatCount="indefinite"/></circle>
    </g>
    <g>
      <animateTransform attributeName="transform" type="rotate" values="0 78 84; 0 78 84; 720 78 84; 2160 78 84; 2520 78 84" keyTimes="0; 0.50; 0.65; 0.88; 1" dur="12s" repeatCount="indefinite"/>
    ...
    <g>
      <animateTransform attributeName="transform" type="rotate" values="0 124 96; 0 124 96; -720 124 96; -1800 124 96; -1980 124 96" keyTimes="0; 0.50; 0.65; 0.88; 1" dur="12s" repeatCount="indefinite"/>
      <circle cx="124" cy="96" r="11" fill="#cbd5e1" stroke="#475569" stroke-width="1.2"/>
      <line x1="124" y1="83" x2="124" y2="109" stroke="#475569" stroke-width="2.5"/><line x1="111" y1="96" x2="137" y2="96" stroke="#475569" stroke-width="2.5"/><circle cx="124" cy="96" r="3.5" fill="#0f172a"/>
    </g>
    <g>
      <animateTransform attributeName="transform" type="rotate" values="0 144 110; 0 144 110; 960 144 110; 2400 144 110; 2640 144 110" keyTimes="0; 0.50; 0.65; 0.88; 1" dur="12s" repeatCount="indefinite"/>
      <circle cx="144" cy="110" r="8" fill="#94a3b8" stroke="#334155" stroke-width="1.2"/>
      <line x1="144" y1="100" x2="144" y2="120" stroke="#334155" stroke-width="2"/><line x1="134" y1="110" x2="154" y2="110" stroke="#334155" stroke-width="2"/><circle cx="144" cy="110" r="2.5" fill="#0f172a"/>
    </g>
    <g>
      <animateTransform attributeName="transform" type="rotate" values="0 78 84; 0 78 84; 360 78 84; 1080 78 84; 1080 78 84; 0 78 84" keyTimes="0; 0.50; 0.65; 0.85; 0.95; 1" dur="12s" repeatCount="indefinite"/>
    ...
    <g clip-path="url(#slotAreaClip)">
      <g transform="translate(182, 30)">
        <g><animateTransform attributeName="transform" type="translate" values="0,-22; 0,-14; 0,-26; 0,-14; 0,-24; 0,-16; 0,-22; 0,-22; 0,0; 0,0; 0,-22" keyTimes="0; 0.04; 0.08; 0.12; 0.14; 0.16; 0.18; 0.33; 0.38; 0.95; 1" dur="12s" repeatCount="indefinite"/>
          <rect x="25" y="0" width="28" height="12" rx="3" fill="#dc2626" stroke="#991b1b" stroke-width="1"/>
          <rect x="34" y="2" width="10" height="8" rx="1.5" fill="#0d1117"/><text x="39" y="8.5" text-anchor="middle" font-family="ui-monospace, monospace" font-size="5.5" font-weight="bold" fill="#facc15">R/T</text>
          <path d="M 12 12 L 66 12 L 68 22 L 62 25 L 16 25 L 10 22 Z" fill="#1e293b" stroke="#0f172a" stroke-width="1.2"/>
          <path d="M 16 25 Q 14 42 20 50 Q 14 60 16 72 L 62 72 Q 64 60 58 50 Q 64 42 62 25 Z" fill="#2a080c" stroke="#ef4444" stroke-width="1.5"/>
          <path d="M 18 28 Q 16 42 22 50 Q 16 60 18 70 L 60 70 Q 62 60 56 50 Q 62 42 60 28 Z" fill="#dc2626" opacity="0.85"/>
          <circle cx="39" cy="46" r="5" fill="#f8fafc" stroke="#64748b" stroke-width="1.2">
            <animate attributeName="cy" values="34; 58; 32; 60; 34; 46; 46" keyTimes="0; 0.04; 0.08; 0.12; 0.16; 0.18; 1" dur="12s" repeatCount="indefinite"/>
          </circle>
      ...
      <g transform="translate(270, 30)">
        <g><animateTransform attributeName="transform" type="translate" values="0,-22; 0,-22; 0,-14; 0,-26; 0,-14; 0,-24; 0,-16; 0,-22; 0,0; 0,0; 0,-22" keyTimes="0; 0.17; 0.20; 0.23; 0.26; 0.29; 0.31; 0.34; 0.40; 0.95; 1" dur="12s" repeatCount="indefinite"/>
          <rect x="25" y="0" width="28" height="12" rx="3" fill="#2563eb" stroke="#1d4ed8" stroke-width="1"/>
          <rect x="34" y="2" width="10" height="8" rx="1.5" fill="#0d1117"/><text x="39" y="8.5" text-anchor="middle" font-family="ui-monospace, monospace" font-size="5.5" font-weight="bold" fill="#facc15">R/T</text>
          <path d="M 12 12 L 66 12 L 68 22 L 62 25 L 16 25 L 10 22 Z" fill="#1e293b" stroke="#0f172a" stroke-width="1.2"/>
          <path d="M 16 25 Q 14 42 20 50 Q 14 60 16 72 L 62 72 Q 64 60 58 50 Q 64 42 62 25 Z" fill="#091426" stroke="#3b82f6" stroke-width="1.5"/>
          <path d="M 18 28 Q 16 42 22 50 Q 16 60 18 70 L 60 70 Q 62 60 56 50 Q 62 42 60 28 Z" fill="#2563eb" opacity="0.85"/>
          <circle cx="39" cy="46" r="5" fill="#f8fafc" stroke="#64748b" stroke-width="1.2">
            <animate attributeName="cy" values="46; 46; 34; 58; 32; 60; 34; 46; 46" keyTimes="0; 0.17; 0.20; 0.23; 0.26; 0.29; 0.31; 0.34; 1" dur="12s" repeatCount="indefinite"/>
          </circle>
    ...
    <g transform="translate(180, 114)">
      ...
      <text x="132" y="16" text-anchor="middle" font-family="ui-monospace, monospace" font-size="8.5" font-weight="bold" letter-spacing="1">
        <animate attributeName="fill" values="#484f58; #484f58; #484f58; #ff7b72; #3fb950; #3fb950; #484f58" keyTimes="0; 0.33; 0.50; 0.62; 0.85; 0.95; 1" dur="12s" repeatCount="indefinite"/>HAGANE MOONSAULT
      </text>
    </g>
...
<img src="./azvi-ascii.svg?v=54" width="{CARD_W}" alt="Azvi Portrait" /><img src="./assets/build-card.svg?v=54" width="{CARD_W}" alt="Kamen Rider Build" />
