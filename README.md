...
<!-- DUAL MINIMAL CARDS -->
<img src="./azvi-ascii.svg?v=34" width="410" alt="Azvi Portrait" /><img src="./assets/build-card.svg?v=34" width="410" alt="Kamen Rider Build" />
...
<!-- AGGREGATED HEATMAP -->
<img src="./contrib-heatmap.svg?v=34" alt="Aggregated Heatmap" width="840" />
