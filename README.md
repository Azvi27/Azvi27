...
<img src="./azvi-ascii.svg?v=100" width="490" alt="Azvi Portrait" /><img src="./assets/build-card.svg?v=100" width="350" alt="Kamen Rider Build" />

<!-- RABBIT-TANK GRADIENT DIVIDER -->
<br><br>
<img src="./assets/divider.svg?v=100" width="840" alt="Divider" />
<br><br>
...
<!-- AGGREGATED HEATMAP -->
<img src="./contrib-heatmap.svg?v=100" alt="Aggregated Heatmap" width="840" />
