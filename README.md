...
<!-- DUAL MINIMAL CARDS -->
<img src="./azvi-ascii.svg?v=35" width="410" alt="Azvi Portrait" /><img src="./assets/build-card.svg?v=35" width="410" alt="Kamen Rider Build" />
...
<!-- AGGREGATED HEATMAP -->
<img src="./contrib-heatmap.svg?v=35" alt="Aggregated Heatmap" width="840" />
